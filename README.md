...
有公开 `source_url` 的招投标分类台账（JSON / CSV）。v2 **129 行**，2026-09-10。
...
评分办法/行业对照行还在 [https://aiwenbiao.cn/data/goods-vs-service](https://aiwenbiao.cn/data/goods-vs-service) 与 [https://aiwenbiao.cn/data/industry](https://aiwenbiao.cn/data/industry)。
