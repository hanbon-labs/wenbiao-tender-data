...
有公开 `source_url` 的招投标分类台账（JSON / CSV）。v1 **68 行**，2026-09-10。

规范站：[https://aiwenbiao.cn/data](https://aiwenbiao.cn/data)
...
评分办法/行业对照同 10 行，还在 [https://aiwenbiao.cn/data/goods-vs-service](https://aiwenbiao.cn/data/goods-vs-service) 与 [https://aiwenbiao.cn/data/industry](https://aiwenbiao.cn/data/industry)。
