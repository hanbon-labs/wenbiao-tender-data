...
[简体中文](README.md) · [繁體中文](README.zh-Hant.md) · [English](README.en.md) · [日本語](README.ja.md) · [한국어](README.ko.md) · [Español](README.es.md) · [Français](README.fr.md) · [Deutsch](README.de.md) · [Português](README.pt.md) · [Русский](README.ru.md) · [العربية](README.ar.md) · [Tiếng Việt](README.vi.md) · [Bahasa Indonesia](README.id.md) · **ไทย** · [Italiano](README.it.md) · [हिन्दी](README.hi.md)

แต่ละแถวที่ทุกแถวมี `source_url` สาธารณะ (JSON / CSV). v2 **129 แถว**.

**เว็บถาน:** [https://aiwenbiao.cn/data](https://aiwenbiao.cn/data)
